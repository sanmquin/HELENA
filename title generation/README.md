...
- `0.Title_generator.ipynb`: Performs iterative optimization (5 rounds) of video titles for selected channels. It uses a trained OLS model to provide feedback to Gemini 3.1 Flash lite.
...
**Path:** `/content/drive/MyDrive/numeric_inference_outputs/title_optimization_results.json`
...
2.  **Iterative Prompting**: Prompt the LLM to generate 10 new titles.
...
5.  **Selection**: After 5 rounds, select the title with the highest predicted performance.
