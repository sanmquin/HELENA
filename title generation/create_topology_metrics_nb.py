...
# 1. Evaluating Initial Suggestions
...
builder.add_markdown("### Correlation Analysis for Initial Topology")
...
builder.add_markdown("### Interpretation\nThe results indicate that...")

# 2. Quality of Iterative Suggestions
builder.add_markdown([
...
if __name__ == "__main__":
    builder.save('title generation/3.Topology_metrics.ipynb')
    print("Generated title generation/3.Topology_metrics.ipynb")
